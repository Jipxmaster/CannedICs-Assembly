...
ap 01 zap zaj aj 01
maj amw
#location 008f: counter += 01, if carry goto 009e ###### main function ######
zap zaj maj ap 5f ap 01
aj 01 zap amw
...
#################################
#main function
#location 015f: calling 15 bit addition
zap zap mw 00		# a = 0000
ap 01 zap mw 00
ap 02 zap mw 01		# b = 0001
ap 03 zap mw 00
ap 04 zap mw 83		# return = 0183
ap 05 zap mw 01
#location 017c
ap 9f zap aj ff aj ff
#location 0183: output result
zap zap mow
ap 01 zap mow
#location 018a: goto 017c
ap 7c ap 01 aj ff
#location 0190